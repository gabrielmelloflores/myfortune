...
public class PasswordResult implements Serializable {
    ...
    /**
     * Scores maiores ou iguais a isso serão considerados aceitáveis. Scores
     * menores serão considerados fracos.
     */
     ...
     * Por default, <code>valid = false</code> e <code>score = 0</code>
     *
     * @param rule A regra que gerou este resultado. Nulo significa "resultado
     * global".
     */
     ...
     * Indica o resultado do score da força da senha.
     *
     * @param score O score da senha, devendo ser sempre um número positivo,
     * entre 0 e 100.
     */
    ...
    /**
     * Indica se este resultado é referente a avaliação global de um
     * PasswordChecker.
     *
     * @return
     */
    ...
    /**
     * Indica se este resultado é referente a avaliação uma PasswordRule
     * específica.
     *
     * @return
     */
    ...
    /**
     * É apenas a negação do {@link #isValid() isValid()}. Facilita a leitura do
     * código.
     *
     ...
     *
     * @return true, se
     * <code>(ACCEPTABLE_THRESHOLD &lt;= score &lt; STRONG_THRESHOLD)</code>
     */
    ...
    /**
     * Reseta os valores para <code>valid = false</code> e
     * <code>score = 0</code>.
     *
